...
public class AuthorsController : ControllerBase
{
        ...
        [FromQuery] AuthorsResourceParameters authorsResourceParameters)
    {
        if (_propertyMappingService
            .ValidMappingExistsFor<AuthorDto, Author>(
                authorsResourceParameters.OrderBy) == false)
        {
            return BadRequest();
        }

        if (_propertyCheckerService.TypeHasProperties<AuthorDto>
                (authorsResourceParameters.Fields) == false)
        {
            return BadRequest(
        ...
        AuthorForCreationWithDateOfDeathDto author)
    {
        ...
        return CreatedAtRoute("GetAuthor",
            new { authorId = linkedResourceToReturn[nameof(AuthorDto.Id)] },
